  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white pt-16 pb-8 flex flex-col items-center">
        <div className="w-20 h-20 rounded-2xl bg-[#60e750] flex items-center justify-center mb-4 shadow-md">
          <span className="material-icons text-white text-4xl">pets</span>
        </div>
        <h1 className="text-2xl font-bold text-gray-800">PetConnect</h1>
        <p className="text-sm text-gray-400 mt-1">为每一只宠物找到温暖的家</p>
      </div>
        ...
        <div className="flex border-b border-gray-100">
          <button
            className={`flex-1 py-4 text-sm font-medium transition-colors ${
              activeTab === 'login' ? 'text-[#60e750] border-b-2 border-[#60e750]' : 'text-gray-400'
            }`}
          ...
          <button
            className={`flex-1 py-4 text-sm font-medium transition-colors ${
              activeTab === 'register' ? 'text-[#60e750] border-b-2 border-[#60e750]' : 'text-gray-400'
            }`}
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:border-[#60e750] transition-colors"
                />
              </div>
              <div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-[#60e750] text-white rounded-xl font-medium text-sm mt-2 disabled:opacity-60 flex items-center justify-center gap-2"
              >
